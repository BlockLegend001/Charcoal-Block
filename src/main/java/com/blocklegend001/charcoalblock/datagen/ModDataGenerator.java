...
public class ModDataGenerator {
    ...
    public static void onGatherData(final GatherDataEvent.Client event) {
        ...
        ModBlockTagsProvider blockTagsProvider = new ModBlockTagsProvider(packOutput, lookupProvider, CharcoalBlock.MODID);
        ...
        event.addProvider(new ModModelProvider(packOutput, CharcoalBlock.MODID));
    }
}
